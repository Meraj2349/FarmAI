              ...
              <li key={link.name}>
                ...
                >
                  ...
                  <span
                    className={`${
                      activeLink === link.href
                        ? "absolute w-full h-1 bg-green-600 top-8 left-0"
                        : "absolute w-full h-1 bg-green-600 top-8 left-0 transition ease-in-out duration-300 transform origin-left scale-x-0 group-hover:scale-x-100"
                    }`}
                  ></span>
                </a>
              </li>
